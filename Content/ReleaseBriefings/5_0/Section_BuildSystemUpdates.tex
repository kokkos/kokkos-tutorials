...
\begin{frame}[fragile]{Defaults and Requirements}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item CMake 2.25.2 is the minimum for \texttt{CUDA} CMake language support
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Support for multiple CMake Languages}
  \begin{itemize}
...
\begin{frame}[fragile]{Windows experimental shared library support}
  \begin{itemize}
    \item Experimental support for shared library builds in Windows
    \begin{itemize}
