...
\begin{frame}[fragile]{Multilanguage and Windows support}
  \begin{itemize}
    \item Kokkos now offers support for multiple languages in one build
    \begin{itemize}
      \item Allow a single Kokkos to be used with the CMake languages \texttt{CXX} and \texttt{CUDA/HIP}.
      \item Kokkos sets the flags for all languages that work with the selected backend.
