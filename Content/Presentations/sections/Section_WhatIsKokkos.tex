...
\begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{../modularized/figures/linux-foundation}
     \end{column}
\hfill
    % Right column
    \begin{column}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{../modularized/figures/hpsf-logo}
      \end{column}
\end{columns}
...
\hfill
    ...
    \begin{column}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{../modularized/figures/hpsf-members}
      \end{column}
\end{columns}
